...
- Generally everything is generic
  ...
  - Number generic examples:
    ...
    - [Vector4](./MeshWiz.Math/Vec4.cs)
    - [Matrix4x4](./MeshWiz.Math/Mat4x4.cs)
  - Most number-type generics offer a [To<TOtherNum>()](./MeshWiz.Math/Vec3.cs) Method to convert between the possible types
